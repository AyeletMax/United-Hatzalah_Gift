...
// Debug route to list all survey routes
app.get('/api/survey-debug', (req, res) => {
  res.json({
    availableRoutes: [
      'GET /api/survey/',
      'GET /api/survey/check/:productId/:userName/:userEmail',
      'GET /api/survey/product/:productId',
      'GET /api/survey/:id',
      'POST /api/survey/',
      'PUT /api/survey/:id',
      'DELETE /api/survey/reset/:productId',
